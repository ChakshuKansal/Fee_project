...
let list7 = document.getElementById('dresses');
let list8 = document.getElementById('homewear');
let list9 = document.getElementById('tracks');
...
function initApp(){
    producttshirt.forEach((value, key) =>{
        ...
        newDiv.addEventListener("click", function () {
            window.open("wom-clothproductpage.html?index=" +keys, "_blank");
        });         
    ...
    productdresses.forEach((value, key) =>{
        let newDiv = document.createElement('div');
        newDiv.classList.add('item');
        newDiv.innerHTML = `
        <div class="shoecard">
