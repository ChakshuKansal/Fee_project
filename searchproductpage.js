...
var newDivimage = `
<div class="image">
    <img class "image" src="${allproductsearch[index].image}">
</div>
<div class="image2">
    <img class="image2" src="${allproductsearch[index].smlimage}">
</div>`;    
images.innerHTML=newDivimage;
var newDiv2 = `
<div id="productname">
<h1>${allproductsearch[index].name}</h1>
</div>
<div id=pricecont">${allproductsearch[index].price}
<br>
<span>Prices includes GST</span>
</div>`;    
list12.innerHTML=newDiv2;
var newDiv3= `<p>${allproductsearch[index].details}<p>`;    
desc.innerHTML=newDiv3;
var newDiv4=`<p>${allproductsearch[index].story}<p>`;    
story.innerHTML=newDiv4;
let newDiv5 = `<li>${allproductsearch[index].features[0]}</li>    
               <li>${allproductsearch[index].features[1]}</li>   
               <li>${allproductsearch[index].features[2]}</li>    
               <li>${allproductsearch[index].features[3]}</li>`;    
